...
public class DoctorFragment extends Fragment implements DeleteMemberClickListener {
    ...
    private void setAdapter() {
        mAdapter = new MemberAdapter(getActivity(),"Doctor",this,itemArrayList);
        mRecyclerView.setAdapter(mAdapter);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    }

    private void mInitViews() {
        mRecyclerView = mView.findViewById(R.id.rv_member_doc);
    }
